...
class Var(object):
    ...
    BOT_TOKEN = str(getenv('BOT_TOKEN', '7063008675:AAG2NCbi5JCdbGHs3SwHrcd903SLO3BzsJo'))
    name = str(getenv('name', 'Vjfiletolink'))
    ...
    APP_NAME = None
    OWNER_USERNAME = str(getenv('OWNER_USERNAME', 'Vijay malia'))
    if 'DYNO' in environ:
        ON_HEROKU = True
